...
%>
<jnlp codebase="http://jbv-tst-oas-01.app.arjustice.local:9001/forms/java/">
  <information>
  ...
  <applet-desc name="Webstart Test Oracle Forms 11g" main-class="oracle.forms.engine.Main" width="990" height="640">
    ...
    <param name="serverURL" value="http://jbv-tst-oas-01.app.arjustice.local:9001/forms/lservlet?ifcfs=http://jbv-tst-oas-01.app.arjustice.local:9001/forms/frmservlet?config=jpi&ifsessid=formsapp.<%=sessid%>"/>
